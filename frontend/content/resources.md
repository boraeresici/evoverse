...
- [Autopoiesis and Cognition](https://en.wikipedia.org/wiki/Autopoiesis) (Maturana & Varela, 1980) and Prof. Dr. Türker Kılıç's network-science ("bağlantısallık") framing: background reading only. A cognitive tier is sketched in `docs/CHIRALITY_AND_MIND.md` as a possible future direction, but nothing in Alpha models cognition and the project makes no claim that chirality produces mind — the physics result stands on its own.
